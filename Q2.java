public class Q2 {
    public static void main(String[] args) {
        ...
        System.out.println("Size of list: " + list.methodSize(list)); // طباعة حجم القائمة باستخدام الأسلوب methodSize()
        System.out.println("Size of list: " + list.size()); // طباعة حجم القائمة باستخدام الأسلوب size()
    }
}